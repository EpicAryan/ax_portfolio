...
// --- Helper Hook to check for mobile viewport ---
...
// --- Prop Interface (remains the same) ---
export interface ScrollRevealProps {
  children: React.ReactNode;
  containerClassName?: string;
  textClassName?: string;
...
// --- The Optimized ScrollReveal Component ---
export function ScrollReveal({
  children,
  containerClassName,
  textClassName,
  ...
  // --- B. Detailed Per-Word Animation for Desktop ---
